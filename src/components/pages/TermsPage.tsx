  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-12 space-y-10">
      ...
      <div className="space-y-6 text-neutral-700 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">3. Prohibited Conduct</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">4. Disclaimer of Warranties</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">5. Limitation of Liability</h2>
          <p>
            In no event shall Money Master Blog or its creator, Shahid Ali, be held liable for any direct, indirect, incidental, or consequential damages resulting from the use of, or inability to use, any tool or calculated output on this site.
          </p>
        </div>

        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">6. Modifications to Terms</h2>
          <p>
            We reserve the right to modify or replace these Terms & Conditions as new tools are added. Any updates become effective immediately upon posting to this page.
          </p>
        </div>

        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">7. Inquiries & Contact</h2>
          <p>
