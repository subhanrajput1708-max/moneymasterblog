  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-12 space-y-10">
      ...
      <div className="space-y-8 text-neutral-700 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">5. Children's Online Privacy</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">6. Changes to this Policy</h2>
          <p>
        ...
        <div>
          <h2 className="text-lg font-bold text-neutral-900 mb-2">7. Contact the Website Author</h2>
          <p>
